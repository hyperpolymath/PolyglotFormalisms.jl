...
# Justfile for PolyglotFormalisms.jl
...
doctor:
    @echo "Running diagnostics for PolyglotFormalisms.jl..."
...
tour:
    @echo "=== PolyglotFormalisms.jl Tour ==="
    @echo ""
...
help-me:
    @echo "=== PolyglotFormalisms.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/PolyglotFormalisms.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: PolyglotFormalisms.jl"
