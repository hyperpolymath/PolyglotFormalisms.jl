{
  description = "PolyglotFormalisms.jl - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 PolyglotFormalisms.jl development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P PolyglotFormalisms.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/PolyglotFormalisms.jl $out/bin/  # Rust
            # cp bin/PolyglotFormalisms.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/PolyglotFormalisms.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-PolyglotFormalisms.jl" {
